...
class VersionInfos:
    ...
    def __init__(self) -> None:
        self.this_version = '''0.7.2'''
        self.this_update_content = '''·设置页面重置
·添加选项卡切换时渐隐渐显动画
·添加选项卡指示器
·个性化页面添加指示器设置和动画设置
·其他微调优化'''
        self.this_update_date = '''2025-12-25'''
...
print(version_info.update_content())
print(version_info.update_date())
    ...
    def paintEvent(self, event):
        ...
        if self.tab_bar_background_color and self.tab_manager.tab_buttons:
            ...
            if active_tab_geometry:
                ...
                # 从设置中获取高亮按钮颜色，默认为钢蓝色
                highlight_color_str = self.settings_manager.Custom.get_value("highlight_button_color", "#4682B4")
                # 解析颜色字符串
