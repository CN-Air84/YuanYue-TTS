...
## 目录 
注：本文档前半部分为使用前须知，中部为使用后须知，后部为致谢与支持，尾部为程序特色介绍。各位媒体老师可以优先看最后“特色介绍”一部分。

感谢各位对本项目的支持！ ~~感谢TV，感谢所有TV~~
...
--[ __Win7/8/8.1如何运行__ ](#Win7881如何运行)
...
-[篇末](#节省了用户抬头看书所需时间的同时辅助用户更快的记忆书本上的知识帮助用户更高效地学习)
...
| 操作系统 | 技术支持 |
|---|---|
| Windows 10 1809 或更高|✅    经测试可运行 |
| Windows 8 - Windows 10 1803  |  ✅ 理论可运行 |
| Windows 7 SP1 7601 | ✅ 经测试可运行（需安装补丁） |
| WinVista 或更低 / 一切32位系统 / 一切Arm系统 / …… | ❌ 理论跑不动，未经测试 |
| macOS / Linux  | ⚠️ 估计跑不动，未经测试 |

    
## 实用功能和亮点
[支持一键 **从图片导入**，平均 **节省14分钟/1000字**](#从图片导入)

[支持一键 **从DOCX文件导入** ，省去三步操作，平均 **节省16s/文档**](#从DOCX文件导入)

[支持 **在线获取教科书文件、指定内容并导入**，**省去五步操作，解放手机** ](#在线获取教科书内容并导入)
...
注：屎山堆得有点多，暂未实现“自定义字体（及字号）”等一系列自定义功能。
