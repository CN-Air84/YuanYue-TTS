...
class DownloadWorker(QThread):
    ...
    def _build_request_headers(self, byte_range: Optional[str] = None) -> Dict[str, str]:
    ...
    def download_chunk(self, thread_id: int, start_pos: int, end_pos: Optional[int]):
        """下载文件块"""
        ...
        if end_pos is not None:
            headers = self._build_request_headers(f'bytes={start_pos}-{end_pos}')
